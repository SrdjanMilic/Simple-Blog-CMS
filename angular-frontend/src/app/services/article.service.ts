...
export class ArticleService {
  ...
  createArticle(article: Article) {
    return this.httpClient.post(`${this.AUTH_SERVER}/api/v1/create-article`, article).subscribe(() => {
  ...
  updateArticle(article: Article) {
    return this.httpClient.put(`${this.AUTH_SERVER}/api/v1/update-article`, article).subscribe(() => {
  ...
  listArticles() {
    return this.httpClient.get(`${this.AUTH_SERVER}/api/v1/list-articles`).subscribe((res: any[]) => {
